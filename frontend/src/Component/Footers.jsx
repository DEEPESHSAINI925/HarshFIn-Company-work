      ...
      <div className="container mx-auto px-6 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.categories.map((link, index) => (
                <li key={index}>
                  <Link to={link.link} className="text-black hover:text-gray-500 text-sm">
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t pt-8 flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <span className="text-blue-500 text-sm">© HarshFin Consuling And Associates Ltd. 2025</span>
          </div>
